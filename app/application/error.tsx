  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-6">
      <div className="max-w-md text-center">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Application Error</h2>
        <p className="text-slate-300 mb-6">
          We encountered an error loading your application form. Please try again or start over from the beginning.
        </p>
